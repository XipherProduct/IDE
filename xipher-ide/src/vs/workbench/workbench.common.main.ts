...
// Alaska AI integration
import './contrib/alaskaAI/browser/alaskaAI.contribution.js';
import './contrib/alaskaAI/browser/alaskaDefaults.contribution.js';

//#region --- alaska AI chat (sign-in + sidebar chat panel)
import './contrib/alaskaChat/browser/alaskaChat.contribution.js';
//#endregion

//#region --- alaska AI inline tab completion (ghost text via Monaco InlineCompletionsProvider)
import './contrib/alaskaCompletion/browser/alaskaCompletion.contribution.js';
//#endregion

//#region --- alaska clock (statusbar clock + aurora dot)
import './contrib/alaskaClock/browser/alaskaClock.contribution.js';
//#endregion

//#region --- alaska coordinates (compass — workspace context popup)
import './contrib/alaskaCoordinates/browser/alaskaCoordinates.contribution.js';
//#endregion

//#region --- alaska statusbar (connection + model + tokens pills)
import './contrib/alaskaStatusbar/browser/alaskaStatusbar.contribution.js';
//#endregion

//#region --- alaska branch pill (current Git branch in statusbar)
import './contrib/alaskaBranchPill/browser/alaskaBranchPill.contribution.js';
//#endregion

//#region --- alaska kernel log (78px strip above statusbar, agent events)
import './contrib/alaskaKernelLog/browser/alaskaKernelLog.contribution.js';
//#endregion

//#region --- alaska onboarding walkthrough (first-run welcome flow)
import './contrib/alaskaOnboarding/browser/alaskaOnboarding.contribution.js';
//#endregion
