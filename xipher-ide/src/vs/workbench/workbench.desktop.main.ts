...
import './services/alaskaMcp/electron-browser/alaskaMcpService.js';
import './services/alaskaWsl/electron-browser/alaskaWslService.js';
import './services/alaskaHooks/electron-browser/alaskaHookHostService.js';
import './services/alaskaUpdate/electron-browser/alaskaUpdateService.js';
...
//#region --- alaska self-updater (off/notify/silent, per-account)
import './contrib/alaskaUpdate/electron-browser/alaskaUpdate.contribution.js';
//#endregion

//#region --- alaska IDE↔web live relay (serve web Code sessions in the open workspace)
import './contrib/alaskaChat/browser/alaskaIdeRelay.contribution.js';
//#endregion
