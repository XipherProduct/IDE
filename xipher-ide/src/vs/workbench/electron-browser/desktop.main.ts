...
export class DesktopMain extends Disposable {
	...
	private async initServices(): Promise<{ serviceCollection: ServiceCollection; logService: ILogService; storageService: NativeWorkbenchStorageService; configurationService: IConfigurationService }> {
		...
		fileService.registerProvider(Schemas.alaskacodeUserData, this._register(new FileUserDataProvider(Schemas.file, diskFileSystemProvider, Schemas.alaskacodeUserData, userDataProfilesService, uriIdentityService, logService)));
	...
	private async createWorkspaceService(
		...
		const configurationCache = new ConfigurationCache([Schemas.file, Schemas.alaskacodeUserData] /* Cache all non native resources */, environmentService, fileService);
