...
export class ExtensionManagementServerService extends Disposable implements IExtensionManagementServerService {
	...
	constructor(
		...
		if (remoteAgentConnection) {
			...
			this.remoteExtensionManagementServer = {
				...
				get label() { return labelService.getHostLabel(Schemas.alaskacodeRemote, remoteAgentConnection.remoteAuthority) || localize('remote', "Remote"); },
			};
		}
	...
	getExtensionManagementServer(extension: IExtension): IExtensionManagementServer {
		...
		if (this.remoteExtensionManagementServer && extension.location.scheme === Schemas.alaskacodeRemote) {
