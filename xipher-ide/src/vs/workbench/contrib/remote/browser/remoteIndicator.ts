...
export class RemoteStatusIndicator extends Disposable implements IWorkbenchContribution {
	...
	private updateRemoteStatusIndicator(): void {
		...
		if (this.remoteAuthority) {
			const hostLabel = this.labelService.getHostLabel(Schemas.alaskacodeRemote, this.remoteAuthority) || this.remoteAuthority;
			switch (this.connectionState) {
				...
				default: {
					...
					const hostNameTooltip = this.labelService.getHostTooltip(Schemas.alaskacodeRemote, this.remoteAuthority);
					if (hostNameTooltip) {
