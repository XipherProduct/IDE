		...
		for (const selector of notebookProviderInfo.selectors) {
			...
			const notebookEditorOptions = {
				...
				canSupportResource: (resource: URI) => {
					...
					return resource.scheme === Schemas.untitled || resource.scheme === Schemas.alaskacodeNotebookCell || this._fileService.hasProvider(resource);
				}
			};
			...
			disposables.add(this._editorResolverService.registerEditor(
				`${Schemas.alaskacodeNotebookCell}:/**/${globPattern}`,
