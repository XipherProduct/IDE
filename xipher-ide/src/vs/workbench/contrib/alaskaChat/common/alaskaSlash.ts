...
export interface IAlaskaSlashContext {
	...
	/** Summarise older messages into the running summary to reclaim context. */
	compactHistory(): Promise<IAlaskaCompactResult>;
}

export interface IAlaskaCompactResult {
	readonly compacted: boolean;
	readonly messagesFolded: number;
	readonly ratioBefore: number | undefined;
	readonly ratioAfter: number | undefined;
}
