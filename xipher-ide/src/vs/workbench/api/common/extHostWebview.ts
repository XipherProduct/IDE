...
export class ExtHostWebview implements vscode.Webview {
	...
	private rewriteOldResourceUrlsIfNeeded(value: string): string {
		...
		const isRemote = this.#extension.extensionLocation?.scheme === Schemas.alaskacodeRemote;
		const remoteAuthority = this.#extension.extensionLocation.scheme === Schemas.alaskacodeRemote ? this.#extension.extensionLocation.authority : undefined;
		return value
