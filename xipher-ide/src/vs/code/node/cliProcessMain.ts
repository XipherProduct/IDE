...
class CliMain extends Disposable {
	...
	private async initServices(): Promise<[IInstantiationService, ITelemetryAppender[]]> {
		...
		fileService.registerProvider(Schemas.alaskacodeUserData, new FileUserDataProvider(Schemas.file, diskFileSystemProvider, Schemas.alaskacodeUserData, userDataProfilesService, uriIdentityService, logService));
