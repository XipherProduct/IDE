...
class CodeMain {
	...
	private createServices(): [IInstantiationService, IProcessEnvironment, IEnvironmentMainService, ConfigurationService, StateService, BufferLogger, IProductService, UserDataProfilesMainService] {
		...
		fileService.registerProvider(Schemas.alaskacodeUserData, new FileUserDataProvider(Schemas.file, diskFileSystemProvider, Schemas.alaskacodeUserData, userDataProfilesMainService, uriIdentityService, logService));
