...
export class AlaskaSettingsInput extends EditorInput {
	...
	override getName(): string {
		return localize('alaska.settings.title', 'Alaska AI Settings');
	}
...
export class AlaskaSettingsEditor extends EditorPane {
	...
	private render(): void {
		...
		title.textContent = localize('alaska.settings.heading', 'Alaska AI Settings');
	...
	private buildBYOCard(): HTMLElement {
		...
		enableSub.textContent = localize('alaska.settings.byo.enableHint', 'When enabled, Alaska AI bypasses our gateway and calls the provider directly.');
