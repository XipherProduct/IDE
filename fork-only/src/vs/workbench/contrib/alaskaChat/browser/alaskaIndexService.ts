...
import { IAlaskaIndexService, IAlaskaIndexProgress, IAlaskaIndexSearchHit, IAlaskaIndexSearchOptions, AlaskaIndexState } from './alaskaIndex.js';
import { abortSignalFrom, base64ToBytes, buildSignedHeaders, bytesToBase64, parseAlaskaApiError } from './alaskaApiClient.js';
import { chunkFile, IAlaskaChunk, isLikelyBinary, approxTokenCount } from './alaskaIndexChunker.js';
...
type _Unused = IAlaskaChunk | AlaskaIndexState;
